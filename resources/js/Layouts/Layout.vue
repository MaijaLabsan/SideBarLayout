<template>
  <div class="flex">
    ...
    <div class="flex flex-col w-64 h-screen px-4 py-8 bg-white border-r dark:bg-gray-800 dark:border-gray-600">
        <h2 class="text-3xl font-semibold text-gray-800 dark:text-white flex justify-center">Maija Majesta</h2>
        <h2 class="text-3xl font-semibold text-gray-800 dark:text-white flex justify-center"> Labsan</h2>
        ...
        <div class="flex flex-col justify-between flex-1 mt-6">
            ...
            <div class="flex items-center px-4 -mx-2">
                <img class="object-cover mx-2 rounded-full h-9 w-9" src="https://scontent.fcrk1-1.fna.fbcdn.net/v/t1.0-9/46886714_2283751851856508_44995473257267200_o.jpg?_nc_cat=105&ccb=1-3&_nc_sid=09cbfe&_nc_eui2=AeEi_6KM7KkL8VlbLs1VfTIiKBMI2VQ9xZAoEwjZVD3FkEMscL6qo3colfRQVzi-qurDdAF8yhucmAOZDyyTQhsV&_nc_ohc=7gVR2UCbiCYAX_F0ZYl&_nc_ht=scontent.fcrk1-1.fna&oh=2f3ef72d730f8d7785f8a02458c0c687&oe=6080A4FA" alt="avatar">
    ...
    <nav class="bg-white shadow dark:bg-gray-800">
        <div class="container px-6 py-3 mx-auto md:flex md:justify-between md:items-center">
            <div class="flex items-center justify-between">
                <div>
                    <a class="text-xl font-bold text-gray-800 dark:text-white md:text-2xl hover:text-gray-700 dark:hover:text-gray-300" href="#">Maija Majesta Labsan</a>
                </div>
